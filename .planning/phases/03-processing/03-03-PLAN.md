...
<task type="auto">
  <name>Task 2: Add tests and ensure directory creation</name>
  <files>
    internal/processing/thumbnail.go
    internal/processing/thumbnail_test.go
  </files>
...
Run: make test to verify tests pass.
  ...
  <done>
Thumbnail generator is complete with proper directory creation, dependency checking, and tests. Ready for integration with processing job handler.
  </done>
</task>
...
<success_criteria>
Thumbnail generation service complete. Produces 300px WebP thumbnails from first PDF page. Gracefully handles corrupt PDFs with placeholder. Ready for processing job handler.
</success_criteria>
